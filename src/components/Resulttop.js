...
export default function Resulttop({navigation,searchfunc,openfunc,currtab}) {
    const [search,setsearch]=React.useState("Pasta")
    let itemsheader=["RICETTE","PIANI","UTENTI","INGREDIENTI"]
    ...
    <View>
      <View style={style.child1}>
            ...
            <TextInput placeholderTextColor={colors.black} selectionColor={colors.black} value={search} onChangeText={(e)=>{
                setsearch(e)
                }} style={style.search} placeholder='Pasta'/>
            </View>
      </View>
