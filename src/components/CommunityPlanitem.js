...
export default function CommunityPlanitem() {
    const[pressed,setpresssed]=React.useState(false)
  return (
    <>
    <View style={{paddingTop:RFPercentage(1),paddingHorizontal:RFPercentage(2.5),display:"flex",flexDirection:"row"
    ,justifyContent:"flex-start",width:"100%"}}>
        <Image style={{height:25,width:25,borderRadius:12.5}} source={require("../Assets/user2.png")}/>
        <Text style={{fontFamily:fonts.PoppinsRegular,marginLeft:RFPercentage(1)}}>Autore</Text>
    </View>
    <TouchableOpacity style={style.parent} onPress={()=>setpresssed(!pressed)}>
    <ImageBackground imageStyle={{borderRadius:RFPercentage(2.5)}} resizeMode='cover' source={require("../Assets/communityplan.png")} style={style.container}>
